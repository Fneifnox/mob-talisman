...
public class ChickenTalisman extends AccessoryItem {

    public ChickenTalisman(Settings properties) {
        super(properties);
    }
    ...
    public void tick(ItemStack stack, SlotReference reference) {
        ...
        player.addStatusEffect(new StatusEffectInstance(StatusEffects.SLOW_FALLING, -1, 0, true, false, true));
    }
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
        tooltip.add(Text.translatable("tooltip.mob-talisman.chicken_talisman"));

        if (CONFIG.showDropchancesAsTooltip()) {
            float dropchance = CONFIG.dropchanceForChickenTalisman();
