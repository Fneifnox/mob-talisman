...
public class DolphinTalisman extends AccessoryItem {

    public DolphinTalisman(Settings properties) {
        super(properties);
    }
    ...
    public void tick(ItemStack stack, SlotReference reference) {
        ...
        player.addStatusEffect(new StatusEffectInstance(StatusEffects.DOLPHINS_GRACE, -1, 0, true, false, true));
    }
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
        tooltip.add(Text.translatable("tooltip.mob-talisman.dolphin_talisman"));

        if (CONFIG.showDropchancesAsTooltip()) {
            float dropchance = CONFIG.dropchanceForDolphinTalisman();
