...
public class ArmadilloBooleanComponent implements BooleanComponent, AutoSyncedComponent {
    private boolean value = false;
    private final Entity provider;

    public ArmadilloBooleanComponent(Entity provider) {
    ...
    public void setValue(boolean value) {
        this.value = value;
        MyComponents.ARMADILLO_FLOATING_ITEM.sync(this.provider);
    }
