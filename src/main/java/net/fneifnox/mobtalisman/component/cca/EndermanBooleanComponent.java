...
public class EndermanBooleanComponent implements BooleanComponent, AutoSyncedComponent {
    private boolean value = false;
    private final Entity provider;

    public EndermanBooleanComponent(Entity provider) {
    ...
    public void setValue(boolean value) {
        this.value = value;
        MyComponents.ENDERMAN_EQUIPPED.sync(this.provider);
