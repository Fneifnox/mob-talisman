...
public class CamelBooleanComponent implements BooleanComponent, AutoSyncedComponent {
    private boolean value = false;
    private final Entity provider;

    public CamelBooleanComponent(Entity provider) {
    ...
    public void setValue(boolean value) {
        this.value = value;
        MyComponents.CAMEL_TALISMAN_ABILITY_READY.sync(this.provider);
