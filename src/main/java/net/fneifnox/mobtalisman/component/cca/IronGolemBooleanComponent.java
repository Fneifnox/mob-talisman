...
public class IronGolemBooleanComponent implements BooleanComponent, AutoSyncedComponent {
    private boolean value = false;
    private final Entity provider;

    public IronGolemBooleanComponent(Entity provider) {
    ...
    public void setValue(boolean value) {
        this.value = value;
        MyComponents.IRON_GOLEM_TALISMAN_ABILITY_READY.sync(this.provider);
