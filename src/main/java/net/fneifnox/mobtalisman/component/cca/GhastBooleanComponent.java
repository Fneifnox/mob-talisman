...
public class GhastBooleanComponent implements BooleanComponent, AutoSyncedComponent {
    private boolean value = false;
    private final Entity provider;

    public GhastBooleanComponent(Entity provider) {
    ...
    public void setValue(boolean value) {
        this.value = value;
        MyComponents.GHAST_TALISMAN_ABILITY_READY.sync(this.provider);
    }
